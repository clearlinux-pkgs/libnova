...
Source0  : https://sourceforge.net/projects/libnova/files/libnova/v%200.15.0/libnova-0.15.0.tar.gz/download
Summary  : No detailed summary available
Group    : Development/Tools
License  : LGPL-2.0
Requires: libnova-bin
Requires: libnova-lib
Requires: libnova-license
...
export LANG=C
export SOURCE_DATE_EPOCH=1536273546
...
export SOURCE_DATE_EPOCH=1536273546
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/libnova
cp COPYING %{buildroot}/usr/share/doc/libnova/COPYING
%make_install
